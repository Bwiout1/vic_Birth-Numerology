...
public class Get_desActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //返回图标
        ImageView num_back = findViewById(R.id.num_des_back);
        ImageView num_go = findViewById(R.id.num_go);
        num_go.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Get_desActivity.this, Get_YearPredit.class);
        ...
        tabLayout = findViewById(R.id.num_tab);
        viewPager = findViewById(R.id.num_viewpager);
        ...
        TextView num_day = findViewById(R.id.num_ran_day);
        TextView num_month = findViewById(R.id.num_ran_mon);
        TextView num_year = findViewById(R.id.num_ran_year);
        ...
        String mWay = String.valueOf(c.get(Calendar.DAY_OF_WEEK));//获取当前星期
        String week_1 = getweek(Integer.parseInt(mWay)+1);
        String week_2 = getweek(Integer.parseInt(mWay)+2);
        String week_3 = getweek(Integer.parseInt(mWay)+3);
        int mDay1 = Integer.parseInt(mDay)+1;
        int mDay2 = Integer.parseInt(mDay)+2;
        int mDay3 = Integer.parseInt(mDay)+3;
        month = getmonth(mMonth);
        tabLayout = findViewById(R.id.num_tab);
        tab_name = new ArrayList<String>();
        tab_name.add(mDay1+" "+month+"."+week_1+"\n"+mYear);
        tab_name.add(mDay2+" "+month+"."+week_2+"\n"+mYear);
        tab_name.add(mDay3+" "+month+"."+week_3+"\n"+mYear);
        //显示tab栏和viewpager
